...
MCP_SERVERS = [
    ...
    },
    {
        ...
        "when": ["HUBROOM", "허브룸", "HUB ROOM", "Bridge", "브릿지",
                 "VHL", "LFT", "CNV", "STK", "STB", "Sorter", "소터",
                 "MLUD", "FOUP", "FOSB", "ZFS", "FIO",
                 "리프터", "컨베이어", "스토커", "층간",
                 "연결 경로", "경유", "위키"],
        # ★"AI"·"MO" 같은 두 글자 포트 이름은 안 넣는다 — "AI 가 뭐야" 가
        #   포트 질문으로 잡힌다. 포트는 '포트' 라는 말이 있을 때만 본다.
        # ★"어떻게" 도 안 넣는다 — "M14 반송 어떻게 되고 있어" 는 상태 질문이다.
        "when_re": (r"(?:OHT|반송|포트|PORT)[^\n]{0,14}"
                    r"(?:뭐|무엇|뜻|의미|역할|차이|설명|구분)"),
        # ★위키 본문은 길다. 통째로 실으면 관제 근거·첨부가 밀려난다.
        "budget": 2500,
        "probe": "listDomains",
        "calls": [
