...
MCP_SERVERS = [
    ...
    },
    {
        ...
        "timeout": 20,
        # ★위키에 **무엇이 들어 있는지 위키에게 물어본다** (제목·태그).
        #   아래 when 은 손으로 적은 목록이라, 문서를 새로 넣으면 여기도
        #   고쳐야 했다 — 그것 때문에 "위키에 넣었는데 왜 안 되냐" 가 됐다.
        #   이제 문서를 넣으면 낱말도 같이 는다 (5분마다 다시 물어본다).
        #   ★아래 when 은 그대로 둔다. 위키가 잠깐 안 붙어도 늘 쓰던 말은
        #     걸려야 한다.
        "when_dyn": "wikiWords",
        # 반송 장치·구조를 묻는 말들.
