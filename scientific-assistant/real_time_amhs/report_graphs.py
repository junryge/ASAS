"""
real_time_amhs/report_graphs.py — 리포트 자동 그래프

★데모스 demos_v1/report_graphs.py 와 같은 내용의 **독립 복사본**이다.
  데모스를 import 하지 않는다. 개인 에이전트 보고서와 그래프가 똑같아야 하므로
  demos_v1/report_graphs.py 를 고치면 이 파일도 같이 맞춘다.
