...
(function () {
  ...
  function injectStyle() {
    ...
    s.textContent = [
      ...
      // ★높이는 **그림만큼**(아래로 늘 끝까지 뻗던 것을 뺐다), 폭은 넓게 —
      //   고객: "더블클릭해서 그래프 보는 건 남는 공간이 너무 많아. 그래프도 작고".
      //   그림이 화면보다 길면 서랍 안에서 굴린다(.bm-gbody overflow:auto).
      '.bm-graph{position:absolute;right:12px;top:12px;max-height:calc(100% - 24px);'
        + 'width:min(74%,1240px);z-index:12;'
