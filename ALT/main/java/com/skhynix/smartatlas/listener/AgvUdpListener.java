...
public class AgvUdpListener {
	private final Logger logger = LoggerFactory.getLogger(getClass());
	private static final String AGV_LISTENER_STOP_LOG = ">>> the thread for AGV Listener is stopped [fab: {} | mcp: {}]";
	private static final String PORT_OPEN_LOG = "> AGV opened port : {} [fab: {} | mcp: {}]";
	...
	public AgvUdpListener(String fabId, String mcpName, int port) {
		this.fabId 		= fabId;
	...
	public AgvUdpListener(String fabId, String mcpName, String ipString, int port) {
		this.port = port;
	...
	public void start() {
		...
		receiveThread = new Thread("AgvMessageQueuing") {
			public void run(){
	...
	private void _closeSocket () {
		if (this.socket != null && !this.socket.isClosed()) {
			try {
				...
				logger.info(AGV_LISTENER_STOP_LOG, fabId, mcpName);
			} catch (Exception e) {
