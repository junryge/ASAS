...
model_dir = os.path.join(script_dir, 'model_25min', 'xgboost_Categorical_V8_25min.pkl')
...
# 모델 메타 (config.json의 models.categorical_25m)
_model_cfg = _cfg["models"]["categorical_25m"]
...
def predict_realtime():
    ...
    if result is None:
        ...
        row = {
            ...
            "RESULT": f"{max_class_name} ({max_prob:.1f}%)",
