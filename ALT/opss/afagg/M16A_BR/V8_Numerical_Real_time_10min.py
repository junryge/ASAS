...
model_dir = os.path.join(script_dir, 'model_10min', 'xgboost_Numerical_V8_10min.pkl')
...
# 모델 메타 (config.json의 models.numerical_10m)
_model_cfg = _cfg["models"]["numerical_10m"]
