...
model_dir = os.path.join(script_dir, 'model_25min', 'xgboost_Numerical_V8_25min.pkl')
...
def realtime_prediction():
    ...
    prediction_time = seq_end + timedelta(minutes=25)
...
# 모델 메타 (config.json의 models.numerical_25m)
_model_cfg = _cfg["models"]["numerical_25m"]
