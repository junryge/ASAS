...
model_dir = os.path.join(script_dir, 'model_15min', 'xgboost_Categorical_V8_15min.pkl')
...
# 모델 메타 (config.json의 models.categorical_15m)
_model_cfg = _cfg["models"]["categorical_15m"]
