...
> ⚠️ **본 문서의 임계값은 v4.1 최초 설계값입니다.**
> 실제 운영 임계값은 **`thresholds.json`** 에서 관리 (코드 수정 없이 조정 가능).
> 2026-06 추천값은 `thresholds.recommended.json` / `RULES_03_임계값.csv` / `AP/5월_30일_검증결과.md` 참조.
