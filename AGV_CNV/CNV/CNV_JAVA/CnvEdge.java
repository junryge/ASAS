 ...
 * (AbstractEdge, JsonToStringBuilder if available)
 */

/**
 * CNV (Conveyor) Edge model representing a conveyor segment in the system.
 * Extends AbstractEdge with conveyor-specific properties.
 *
 * Features:
 * - avgTransferIntervalT: Average transfer interval (300-30000ms range)
 * - Weighted moving average cost calculation
 * - Availability checking based on connected nodes
 */
