 ...
 * (AbstractEdge, Stocker, StkPortNode, DataService classes if available)
 */

/**
 * Stocker Room Edge model for CNV/Stocker system integration.
 * Extends AbstractEdge with stocker-specific properties and behavior.
 *
 * Manages:
 * - Equipment (EQP) identification
 * - Average transfer costs for stocker room operations
 * - Moving carrier tracking
 * - Bridge room edge detection
 * - Room direction (from/to room)
 */
