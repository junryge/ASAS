 ...
 * - AbstractEdge, EDGE_TYPE, RAIL_DIRECTION (from framework)
 * - DataService, DataSet, Station, Command (from framework)
 * - Vhl and enums (VHL_STATE, VHL_DET_STATE, VHL_CYCLE, RUN_CYCLE)
 * - PredictionPara (from framework)
 */

/**
 * Rail track segment model for AGV system with velocity tracking and density calculation.
 * Extends AbstractEdge to represent connections between RailNodes.
 * Tracks vehicles on the edge, calculates weighted moving average velocity,
 * maintains passage history, and provides density analysis.
 */
public class RailEdge extends AbstractEdge {
    ...
    public Map<Vhl.VHL_STATE, Integer> getCurrentVhlStateMap(){
    ...
    public Map<Vhl.VHL_DET_STATE, Integer> getCurrentVhlDetStateMap(){
    ...
    public Map<Vhl.VHL_CYCLE, Integer> getCurrentVhlCycleMap(){
        Map<Vhl.VHL_CYCLE, Integer> vhlCycleMap = new HashMap<>();
    ...
    public Map<Vhl.RUN_CYCLE, Integer> getCurrentVhlRunCycleMap(){
        Map<Vhl.RUN_CYCLE, Integer> vhlRunCycleMap = new HashMap<>();
