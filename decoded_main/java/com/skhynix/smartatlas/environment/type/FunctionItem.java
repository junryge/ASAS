...
public class FunctionItem {
    ...
    private Boolean useTibrvSend = null;
    ...
    private Boolean useCnvInout = null;
    private Boolean useCnvTibrvSend = null;
    private Boolean useAgvInout = null;
    private Boolean useAgvTibrvSend = null;
    ...
    public boolean isUseTibrvSend() {
        return useTibrvSend != null && useTibrvSend;
    }
    ...
    public boolean isUseCnvInout() {
        return useCnvInout != null && useCnvInout;
    }
    
    public boolean isUseCnvTibrvSend() {
        return useCnvTibrvSend != null && useCnvTibrvSend;
    }
    
    public boolean isUseAgvInout() {
        return useAgvInout != null && useAgvInout;
    }
    
    public boolean isUseAgvTibrvSend() {
        return useAgvTibrvSend != null && useAgvTibrvSend;
    }
    ...
    public void setUseFunction(FunctionType key, Boolean isAvailable) {
        switch (key) {
            ...
            case CNV_INOUT: {
                this.useCnvInout = isAvailable;
            } break;            
            case CNV_TIBRV_SEND: {
                this.useCnvTibrvSend = isAvailable;
            } break;            
            case AGV_INOUT: {
                this.useAgvInout = isAvailable;
            } break;
            case AGV_TIBRV_SEND: {
                this.useAgvTibrvSend = isAvailable;
            } break;
        ...
        switch (key) {
            ...
            case CNV_INOUT: {
                if (nullable) {
                    ...
                    return isUseCnvInout();
                }
            }
            case CNV_TIBRV_SEND: {
                if (nullable) {
                    return useCnvTibrvSend;
                } else {
                    return isUseCnvTibrvSend();
                }
            }            
            case AGV_INOUT: {
                if (nullable) {
                    ...
                    return isUseAgvInout();
                }
            }
            case AGV_TIBRV_SEND: {
                if (nullable) {
                    return useAgvTibrvSend;
                } else {
                    return isUseAgvTibrvSend();
                }
            }            
            default: {
                this._notRegistered(key);
...
//        ITSM_SCHEDULE_MONITORING("ITSM_SCHEDULE_MONITORING"),
        ...
        TIBRV_SEND("TIBRV_SEND"),
        CNV_INOUT("CNV_INOUT"),
        CNV_TIBRV_SEND("CNV_TIBRV_SEND"),
        AGV_INOUT("AGV_INOUT"),
        AGV_TIBRV_SEND("AGV_TIBRV_SEND");
