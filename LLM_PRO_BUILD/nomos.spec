...
"""
Nomos LLM Desktop - PyInstaller spec 파일 (Windows 빌드용)
빌드: pyinstaller nomos.spec --noconfirm
"""
...
a = Analysis(
    ...
    excludes=[
        ...
        # 미설치 선택 패키지 (설치된 경우 excludes에서 제거)
        # 'llama_cpp',
        # 'aider', 'aider_chat',
        # 'nanobot',
        # 대형 ML/DL 프레임워크
