...
<div class="contents_wrap" id="body_<c:out value="${param.uuid }" />">
        ...
        <div class="loc_info_basic">
            ...
            <span class="loc_info_ico loc_info_ico_arr_depth"></span>
            <span class="location_box"><spring:message code="site.alarmReportLogList" text="default text" /></span>
        </div>
        <!-- //Location Information -->
        <!-- Page Title -->
        <table class="page_tit">
            <tr>
                <td class="tit_area">
                    <div class="tit"><spring:message code="site.alarmReportLogList" text="default text" /></div>
                </td>
            </tr>
        </table>
        <!-- //Page Title -->
...
<script type="text/javascript">
	$content = $("#body_${param.uuid }");
 	$(document).ready(function(){
			...
			$content.find("#areaName").change(function(){
				...
				getBayFromArea(_fabSite,"fab", "areaName", "bayName");	// 2021. 04. 01. X0122410 :
			...
			$content.find('input[name="rdoFabSite"]').change(function() {
				/*
			    $content.find('input[name="rdoFabSite"]').each(function() {
				...
				*/
				...
				getFabFromFabSite("alarm", _fabSite, "fab", "tdFab");
     ...
     function setFilter<c:out value="${param.uuid }" />(){
     	...
     	if(filter == "01"){
 			...
 			$content.find('#singleFilterChkBoxFab').find(':checkbox').prop('disabled',false);
 			...
 			$content.find('#singleFilterChkBoxFab').find(':checkbox').prop('disabled',true);
	...
	function getLogList<c:out value="${param.uuid }" />(page){
		...
		var url = "<c:url value="/alarm/ajax/getAlarmReportLogList.do" />";
