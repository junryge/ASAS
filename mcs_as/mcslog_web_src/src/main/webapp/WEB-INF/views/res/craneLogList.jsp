...
<div class="contents_wrap" id="body_<c:out value="${param.uuid }" />">
        ...
        <div class="loc_info_basic">
            ...
            <span class="loc_info_ico loc_info_ico_arr_depth"></span>
            <span class="location_box">
                <a href="javascript:movePage('<c:url value="/res/craneLogList.do" />');" class="location"><spring:message code="site.craneLogList" text="default text" /></a>
            </span>
        </div>
        <!-- //Location Information -->
        <!-- Page Title -->
        <table class="page_tit">
            <tr>
                <td class="tit_area">
                    <div class="tit"><spring:message code="site.craneLogList" text="default text" /></div>
                </td>
            </tr>
        </table>
        <!-- //Page Title -->
					                                ...
					                                <tr class="multiFilter" >
					                                 	<td class="condition_t_data" colspan="3">
					                                    	 <input type="text" id="machineName2" name="machineName2"  style="width:185px" value="<c:out value="${param.machineName2 }" />" />
			                                                    <a href="#" class="btn_txt btn_type_c btn_color_b" id="machineBtn" style="width:80px;">
			                                                        <span class="txt">Machine</span>
			                                                    </a>
					                                    </td>					                                    
					                                </tr>
					                            </tbody>
           								...
           								<div class="srch_type01">
        									<div class="condition_area">
					                            ...
					                            <tbody>
					                                ...
					                                <tr>
					                                	<th scope="col" class="condition_t_head">Crane Name</th>
					                                    <td class="condition_t_data">
					                                         <input type="text" id="craneName" name="craneName" value="<c:out value="${param.craneName }" />" />
					                                    </td>
					                                </tr>
					                                <tr>
					                                ...
					                                <tr>
					                                	<th scope="col" class="condition_t_head">ProcessingState</th>
					                                    <td class="condition_t_data">
...
<script type="text/javascript">
	$content = $("#body_${param.uuid }");
 	$(document).ready(function(){
			...
			// 슬라이드 효과
			$content.find(".sechOpt").click(function(){
				if($(this).hasClass('folder')){	// folder close
	...
	function drawGrid<c:out value="${param.uuid }" />(){
		var columns = [
			  ...
			  {id: "CRANE", name: "CRANE", field: "CRANENAME",  sortable: true},
			  {id: "STATE", name: "STATE", field: "STATE",  sortable: true},
			  {id: "PROCESSINGSTATE", name: "PROCESSINGSTATE", field: "PROCESSINGSTATE",  sortable: true},
			  {id: "SUBSTATE", name: "SUBSTATE", field: "SUBSTATE",  sortable: true},
			  {id: "T/R COMMANDID", name: "T/R COMMANDID", field: "TRANSPORTCOMMANDID",  sortable: true},
			];
		var options = {
	...
	function getLogList<c:out value="${param.uuid }" />(page){
		...
		//console.dir(param);
		var url = "<c:url value='/res/ajax/getCraneLogList.do' />";
		$.ajax({
	            url: url,
	            type:'post',
	            data: param,
  	...
  	function setSearchOption<c:out value="${param.uuid }" />(colName , colValue){
  		...
  		switch(colName) {
		    case "MACHINENAME":
		        ...
		        break;
		    case "CRANENAME":
		    	$content.find("#craneName").val(colValue);
		        break;
		    case "STATE":
