...
<div class="contents_wrap" id="body_<c:out value="${param.uuid }" />">
        ...
        <div class="loc_info_basic">
            <span class="location_box">
                <a href="javascript:movePage('<c:url value="/tot/totalLogList.do" />');" class="location"><span class="loc_info_ico loc_info_ico_home"></span>Home</a>
            </span>
            <span class="loc_info_ico loc_info_ico_arr_depth"></span>
            <span class="location_box">
                <a href="javascript:movePage('<c:url value="/res/machineLogList.do" />');" class="location">Resource</a>
            </span>
            <span class="loc_info_ico loc_info_ico_arr_depth"></span>
            <span class="location_box">
                <a href="javascript:movePage('<c:url value="/res/portLogList.do" />');" class="location"><spring:message code="site.portLogList" text="default text" /></a>
            </span>
        </div>
        <!-- //Location Information -->
        <!-- Page Title -->
        <table class="page_tit">
            <tr>
                <td class="tit_area">
                    <div class="tit"><spring:message code="site.portLogList" text="default text" /></div>
                </td>
            </tr>
        </table>
        <!-- //Page Title -->
                    ...
                    <div class="lay_item_box">
                                        ...
                                        <div class="tab_contents" id="tree_set_tab_contents1">
        									...
        									<div class="condition_area">
					                            ...
					                            <tbody id="test">
					                                <tr>
					                                    <td class="condition_t_head_top" colspan="3">
					                                    	<span class="sechOpt folder" ></span>
					                                    	<span>Machine</span>
					                                    </td>
					                                </tr>
					                                <tr>
           								...
           								<div class="srch_type01">
        									<div class="condition_area">
					                            ...
					                            <tbody>
					                                ...
					                                <tr>
					                                	<th scope="col" class="condition_t_head">Port Name</th>
					                                    <td class="condition_t_data">
					                                         <input type="text" id="portName" name="portName" value="<c:out value="${param.portName }" />" />
					                                    </td>
					                                </tr>
					                                <tr>
					                                	<th scope="col" class="condition_t_head" style="width:200px">State</th>
					                                    <td class="condition_t_data">
					                                         <input type="text" id="state" name="state" value="<c:out value="${param.state }" />" />
					                                    </td>
					                                </tr>
					                                <tr>
					                                	<th scope="col" class="condition_t_head">Sub State</th>
					                                    <td class="condition_t_data">
					                                         <input type="text" id="subState" name="subState" value="<c:out value="${param.subState }" />" />
					                                    </td>
					                                </tr>
					                                <tr>
					                                	<th scope="col" class="condition_t_head">Processing State</th>
					                                    <td class="condition_t_data">
					                                         <input type="text" id="processingState" name="processingState" value="<c:out value="${param.processingState }" />" />
					                                    </td>
					                                </tr>
					                                <tr>
					                                	<th scope="col" class="condition_t_head">Banned</th>
					                                    <td class="condition_t_data">
					                                         <input type="text" id="banned" name="banned" value="<c:out value="${param.banned }" />" />
					                                    </td>
					                                </tr>
					                                <tr>
					                                	<th scope="col" class="condition_t_head">Crane Available</th>
					                                    <td class="condition_t_data">
					                                         <input type="text" id="transportUnitAccessible" name="transportUnitAccessible" value="<c:out value="${param.transportUnitAccessible }" />" />
					                                    </td>
					                                </tr>
					                                <tr>
					                                	<th scope="col" class="condition_t_head">In/Out Type</th>
					                                    <td class="condition_t_data">
					                                         <input type="text" id="inOutType" name="inOutType" value="<c:out value="${param.inOutType }" />" />
					                                    </td>
					                                </tr>
					                                <tr>
					                                	<th scope="col" class="condition_t_head">Manual</th>
					                                    <td class="condition_t_data">
					                                         <input type="text" id="manual" name="manual" value="<c:out value="${param.manual }" />" />
					                                    </td>
					                                </tr>
					                                <tr>
					                                	<th scope="col" class="condition_t_head">AccessMode</th>
					                                    <td class="condition_t_data">
					                                         <input type="text" id="accessMode" name="accessMode" value="<c:out value="${param.accessMode }" />" />
					                                    </td>
					                                </tr>
					                                <tr>
					                                	<th scope="col" class="condition_t_head">IdRead State</th>
					                                    <td class="condition_t_data">
					                                         <input type="text" id="idReadState" name="idReadState" value="<c:out value="${param.idReadState }" />" />
					                                    </td>
					                                </tr>
					                            </tbody>
					                        </table>
                        ...
                        <div class="lay_item_right">
                            ...
                            <div id="grid_container<c:out value="${param.uuid }" />">
                                   	<div id="list<c:out value="${param.uuid }" />" class="gridForResize_single" style="width:100%;height:910px; background: white; outline: 0; border: 1px solid gray;"></div>
...
<script type="text/javascript">
	$content = $("#body_${param.uuid }");
 	$(document).ready(function(){
			...
			$content.find(".board_list_data").dblclick(function() {
				...
				switch(colName) {
				    case "time":
				    	$content.find("#time").val(colValue);
				        break;
				    case "machineName":
				    	$content.find("#machineName").val(colValue);
				        break;
				    case "portName":
				    	$content.find("#portName").val(colValue);
				        break;
				    case "state":
				    	$content.find("#state").val(colValue);
				        break;
				    case "processingState":
				    	$content.find("#processingState").val(colValue);
				        break;
				    case "subState":
				    	$content.find("#subState").val(colValue);
				        break;
				    case "inOutType":
				    	$content.find("#inOutType").val(colValue);
				        break;
				    case "manual":
				    	$content.find("#manual").val(colValue);
				        break;
				    case "occupied":
				    	$content.find("#occupied").val(colValue);
				        break;
				    case "banned":
				    	$content.find("#banned").val(colValue);
				        break;
				    case "transportUnitAccessible":
				    	$content.find("#transportUnitAccessible").val(colValue);
				        break;
				    case "accessMode":
				    	$content.find("#accessMode").val(colValue);
				        break;
				    default:
				}
	...
	function drawGrid<c:out value="${param.uuid }" />(){
		var columns = [
		  ...
		  {id: "MACHINE", name: "MACHINE", field: "MACHINENAME",  sortable: true},
		  {id: "MACHINETYPE", name: "MACHINETYPE", field: "MACHINETYPE", minWidth: 60, sortable: true},
		  {id: "PORT", defaultSortAsc: false, name: "PORT", field: "PORTNAME", width: 80, sortable: true},
		  {id: "STATE", name: "STATE", field: "STATE", minWidth: 60,  sortable: true},
		  {id: "PROCESSINGSTATE", name: "PROCESSINGSTATE", field: "PROCESSINGSTATE", minWidth: 60,  sortable: true},
		  {id: "SUBSTATE", name: "SUBSTATE", field: "SUBSTATE", minWidth: 60, sortable: true},
		  {id: "INOUTTYPE", name: "INOUTTYPE", field: "INOUTTYPE", minWidth: 60, sortable: true},
		  {id: "MANUAL", name: "MANUAL", field: "MANUAL", minWidth: 60, sortable: true},
		  {id: "OCCUPIED", name: "OCCUPIED", field: "OCCUPIED", minWidth: 60, sortable: true},
		  {id: "BANNED", name: "BANNED", field: "BANNED", minWidth: 60, sortable: true},
		  {id: "TRANSPORTUNITACCESSIBLE", name: "TRANS. UNIT ACCESSIBLE", field: "TRANSPORTUNITACCESSIBLE", minWidth: 60, sortable: true},
		  {id: "IDREADSTATE", name: "IDREADSTATE", field: "IDREADSTATE", minWidth: 60, sortable: true},
		  {id: "ACCESSMODE", name: "ACCESSMODE", field: "ACCESSMODE", minWidth: 60, sortable: true}
		];
	var options = {
	...
	function getLogList<c:out value="${param.uuid }" />(page){
		...
		var url = "<c:url value="/res/ajax/getPortLogList.do" />";
	...
	// searchOption 세팅
  	function setSearchOption<c:out value="${param.uuid }" />(colName , colValue){
	    ...
	    case "ACCESSMODE":
	        ...
	        break;
	    case "IDREADSTATE":
	    	$content.find("#idReadState").val(colValue);
	        break;
	    default:
		}
  	}
