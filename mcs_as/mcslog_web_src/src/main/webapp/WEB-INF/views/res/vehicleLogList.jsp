...
<div class="contents_wrap" id="body_<c:out value="${param.uuid }" />">
        ...
        <div class="loc_info_basic">
            ...
            <span class="loc_info_ico loc_info_ico_arr_depth"></span>
            <span class="location_box">
                <a href="javascript:movePage('<c:url value="/res/vehicleLogList.do" />');" class="location"><spring:message code="site.vehicleLogList" text="default text" /></a>
            </span>
        </div>
        <!-- //Location Information -->
        <!-- Page Title -->
        <table class="page_tit">
            <tr>
                <td class="tit_area">
                    <div class="tit"><spring:message code="site.vehicleLogList" text="default text" /></div>
                </td>
            </tr>
        </table>
        <!-- //Page Title -->
           								...
           								<div class="srch_type01">
        									<div class="condition_area">
					                            ...
					                            <tbody>
					                                ...
					                                <tr>
					                                	<th scope="col" class="condition_t_head">Vehicle Name</th>
					                                    <td class="condition_t_data">
					                                         <input type="text" id="vehicleName" name="vehicleName" value="<c:out value="${param.vehicleName }" />" />
					                                    </td>
					                                </tr>
					                                <tr>
					                                ...
					                                <tr>
					                                	<th scope="col" class="condition_t_head">SubState</th>
					                                    <td class="condition_t_data">
					                                ...
					                                <tr>
					                                	<th scope="col" class="condition_t_head">T/R CommandId</th>
					                                    <td class="condition_t_data">
					                                         <input type="text" id="transportCommandId" name="transportCommandId" value="<c:out value="${param.transportCommandId }" />" />
					                                    </td>
					                                </tr>
					                                <tr>
					                                ...
					                                <tr>
					                                	<th scope="col" class="condition_t_head">TransferPort Name</th>
					                                    <td class="condition_t_data">
					                                         <input type="text" id="transportName" name="transportName" value="<c:out value="${param.transportName }" />" />
					                                    </td>
					                                </tr>
					                                <tr>
					                                	<th scope="col" class="condition_t_head">IdReadState</th>
					                                    <td class="condition_t_data">
...
<script type="text/javascript">
	...
	function drawGrid<c:out value="${param.uuid }" />(){
		var columns = [
		  ...
		  {id: "MESSAGENAME", name: "MESSAGENAME", field: "MESSAGENAME", minWidth: 60, sortable: true},
		  ...
		  {id: "VEHICLE", name: "VEHICLE", field: "VEHICLENAME", minWidth: 60, sortable: true},
		  ...
		  {id: "T/R COMMANDID", name: "T/R COMMANDID", field: "TRANSPORTCOMMANDID", minWidth: 60, sortable: true},
		  {id: "CARRIER", name: "CARRIER", field: "CARRIER", minWidth: 60, sortable: true},
		  {id: "TRANSFERPORT", name: "TRANSFERPORT", field: "TRANSFERPORTNAME", minWidth: 60, sortable: true},
  	...
  	function setSearchOption<c:out value="${param.uuid }" />(colName , colValue){
  		console.log(colName);
		    ...
		    case "MACHINENAME":
		        ...
		        break;
		    case "VEHICLENAME":
		    	$content.find("#vehicleName").val(colValue);
		        break;
		    case "STATE":
		    ...
		    case "TRANSPORTCOMMANDID":
		    	$content.find("#transportCommandId").val(colValue);
		        break;
		    case "CARRIER":
		    	$content.find("#carrier").val(colValue);
		        break;
		    case "TRANSFERPORTNAME":
		    	$content.find("#transportName").val(colValue);
		        break;
		    case "IDREADSTATE":
	...
	function getLogList<c:out value="${param.uuid }" />(page){
		...
		//console.dir(param);
		var url = "<c:url value='/res/ajax/getVehicleLogList.do' />";
		$.ajax({
	            url: url,
	            type:'post',
	            data: param,
