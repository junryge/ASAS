...
<div class="contents_wrap" id="body_<c:out value="${param.uuid }" />">
        ...
        <div class="loc_info_basic">
            ...
            <span class="loc_info_ico loc_info_ico_arr_depth"></span>
            <span class="location_box">
                <a href="javascript:movePage('<c:url value="/res/storageLogList.do" />');" class="location"><spring:message code="site.storageLogList" text="default text" /></a>
            </span>
        </div>
        <!-- //Location Information -->
        <!-- Page Title -->
        <table class="page_tit">
            <tr>
                <td class="tit_area">
                    <div class="tit"><spring:message code="site.storageLogList" text="default text" /></div>
                </td>
            </tr>
        </table>
        <!-- //Page Title -->
           								...
           								<div class="srch_type01">
        									<div class="condition_area">
					                            ...
					                            <tbody>
					                                ...
					                                <tr>
					                                	<th scope="col" class="condition_t_head" style="width:200px">FullState</th>
					                                    <td class="condition_t_data">
					                                         <input type="text" id="fullState" name="fullState" value="<c:out value="${param.fullState }" />" />
					                                    </td>
					                                </tr>
					                                <tr>
...
<script type="text/javascript">
			...
			$content.find(".board_list_data").dblclick(function() {
				...
				switch(colName) {
				    ...
				    case "machineName":
				        ...
				        break;
				    case "fullState":
				    	$content.find("#fullState").val(colValue);
				        break;
				    case "state":
	...
	function drawGrid<c:out value="${param.uuid }" />(){
		var columns = [
		  ...
		  {id: "FULLSTATE", name: "FULLSTATE", field: "FULLSTATE", minWidth: 60, sortable: true},
	...
	function getLogList<c:out value="${param.uuid }" />(page){
		...
		//console.dir(param);
		var url = "<c:url value='/res/ajax/getStorageLogList.do' />";
		$.ajax({
	            url: url,
	            type:'post',
	            data: param,
