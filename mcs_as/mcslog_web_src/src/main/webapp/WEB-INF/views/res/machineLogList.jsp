...
<div class="contents_wrap" id="body_<c:out value="${param.uuid }" />">
         ...
         <div class="loc_info_basic">
             ...
             <span class="loc_info_ico loc_info_ico_arr_depth"></span>
             <span class="location_box">
                 <a href="javascript:movePage('<c:url value="/res/machineLogList.do" />');" class="location"><spring:message code="site.machineLogList" text="default text" /></a>
             </span>
         </div>
         <!-- //Location Information -->
         <!-- Page Title -->
         <table class="page_tit">
             <tr>
                 <td class="tit_area">
                     <div class="tit"><spring:message code="site.machineLogList" text="default text" /></div>
                 </td>
             </tr>
         </table>
         <!-- //Page Title -->
            								...
            								<div class="srch_type01">
         									<div class="condition_area">
					                            ...
					                            <tbody>
					                                ...
					                                <tr>
					                                	<th scope="col" class="condition_t_head" style="width:200px">Connection State</th>
					                                    <td class="condition_t_data">
					                                         <input type="text" id="connectionState" name="connectionState" value="<c:out value="${param.connectionState }" />" />
					                                    </td>
					                                </tr>
					                                <tr>
					                                	<th scope="col" class="condition_t_head">Control State</th>
					                                    <td class="condition_t_data">
					                                         <input type="text" id="controlState" name="controlState" value="<c:out value="${param.controlState }" />" />
					                                    </td>
					                                </tr>
					                                <tr>
					                                	<th scope="col" class="condition_t_head">TSC State</th>
					                                    <td class="condition_t_data">
					                                         <input type="text" id="tscState" name="tscState" value="<c:out value="${param.tscState }" />" />
					                                    </td>
					                                </tr>
					                                <tr>
			...
			$content.find(".board_list_data").dblclick(function() {
				...
				switch(colName) {
				    case "state":
				        ...
				        break;
				    case "controlState":
				    	$content.find("#controlState").val(colValue);
				        break;
				    case "connectionState":
				    	$content.find("#connectionState").val(colValue);
				        break;
				    case "tscState":
				    	$content.find("#tscState").val(colValue);
				        break;
  ...
  // searchOption 세팅
	...
	function drawGrid<c:out value="${param.uuid }" />(){
		var columns = [
			  ...
			  {id: "STATE", defaultSortAsc: false, name: "STATE", field: "STATE", width: 80, sortable: true},
			  {id: "CONTROLSTATE", name: "CONTROLSTATE", field: "CONTROLSTATE", minWidth: 60,  sortable: true},
			  {id: "CONNECTIONSTATE", name: "CONNECTIONSTATE", field: "CONNECTIONSTATE", minWidth: 60,  sortable: true},
			  {id: "TSCSTATE", name: "TSCSTATE", field: "TSCSTATE", minWidth: 60,  sortable: true},
	...
	function getLogList<c:out value="${param.uuid }" />(page){
		...
		//console.dir(param);
		var url = "<c:url value='/res/ajax/getMachineLogList.do' />";
		$.ajax({
	            url: url,
	            type:'post',
	            data: param,
