...
<div class="contents_wrap" id="body_<c:out value="${param.uuid }" />">
                ...
                <div class="loc_info_basic">
                    ...
                    <span class="loc_info_ico loc_info_ico_arr_depth"></span>
                    <span class="location_box">
                        <a href="javascript:movePage('<c:url value="/tran/returnJobLogList.do" />')" class="location"><spring:message code="site.returnJobLogList" text="default text" /></a>
                    </span>
                </div>
                <!-- //Location Information -->
                <!-- Page Title -->
                <table class="page_tit">
                    <tr>
                        <td class="tit_area">
                            <div class="tit"><spring:message code="site.returnJobLogList" text="default text" /></div>
                        </td>
                    </tr>
                </table>
                <!-- //Page Title -->
                                                ...
                                                <div class="tab_contents" id="tree_set_tab_contents1">
							                            ...
							                            <tbody>
							                                ...
							                                <tr>
							                                    <td class="condition_t_data" colspan="2">
							                                         <input type="radio" class="jqForm" id="searchOption1" name="searchOption" value="carrier" checked="checked" ><label for="srch_radio00">Carrier</label>
							                                         <input type="radio" class="jqForm" id="searchOption2" name="searchOption" value="lotId" ><label for="srch_radio00">LotId</label>
							                                    </td>
							                                </tr>
							                                <tr>
							                                    <td class="condition_t_data" colspan="2">
							                                        <input type="text" id="carrierLotId" name="carrierLotId" value="<c:out value="${param.carrierLotId }" />" />
							                                    </td>
							                                </tr>
							                            </tbody>
							                        </table>
                									...
                									<div class="condition_area">
							                            ...
							                            <tbody>
							                                ...
							                                <tr>
							                                    <td class="condition_t_data" colspan="2">
							                                        <input type="text" id="transportJobId" name="transportJobId" value="<c:out value="${param.transportJobId }" />" />
							                                    </td>
							                                </tr>
							                            </tbody>
							                        </table>
                                                        ...
                                                        <table class="condition_table" summary="<spring:message code="site.common.filter" text="default text" />">
								                            ...
								                            <tbody id="test">
								                                ...
								                                <tr class="singleFilterFrom" >
								                                    <th scope="col" class="condition_t_head">BAY</th>
								                                    <td class="condition_t_data" colspan="2" >
								                                         <select class="bayName" name="fromBayName" style="width: 143px" >
								                                            <option value="ALL" selected="selected" >ALL</option>
								                                        </select>
								                                    </td>
								                                </tr>
                									...
                									<div class="condition_area">
							                            ...
							                            <tbody>
							                                ...
							                                <tr>
							                                	 ...
							                                	 <td class="condition_t_data" >
							                                    	<input type="checkbox" class="jqForm" id="state2" name="state2" value="COMPLETED"  <c:if test="${param.state2 == 'COMPLETED' }" >checked="checked"</c:if>><label for="state2">COMPLETED</label>
							                                    </td>
							                                </tr>
							                                <tr>
							                                	 <td class="condition_t_data" >
							                                    	<input type="checkbox" class="jqForm" id="state3" name="state3" value="CREATED"  <c:if test="${param.state3 == 'CREATED' }" >checked="checked"</c:if>><label for="state3">CREATED</label>
							                                    </td>
							                                	 <td class="condition_t_data" >
							                                    	<input type="checkbox" class="jqForm" id="state4" name="state4" value="COMPLETEFAILED"  <c:if test="${param.state4 == 'COMPLETEFAILED' }" >checked="checked"</c:if>><label for="state4">COMPLETEFAILED</label>
							                                    </td>
							                                </tr>
							                                <tr>
							                                	 <td class="condition_t_data" >
							                                    	<input type="checkbox" class="jqForm" id="state5" name="state5" value="QUEUING"  <c:if test="${param.state5 == 'QUEUING' }" >checked="checked"</c:if>><label for="state5">QUEUING</label>
							                                    </td>
							                                	 <td class="condition_t_data" >
							                                    	<input type="checkbox" class="jqForm" id="state6" name="state6" value="TERMINATED"  <c:if test="${param.state6 == 'TERMINATED' }" >checked="checked"</c:if>><label for="state6">TERMINATED</label>
							                                    </td>
							                                </tr>
							                                <tr>
							                                	 <td class="condition_t_data" >
							                                    	<input type="checkbox" class="jqForm" id="state7" name="state7" value="QUEUED"  <c:if test="${param.state7 == 'QUEUED' }" >checked="checked"</c:if>><label for="state7">QUEUED</label>
							                                    </td>
							                                	 <td class="condition_t_data" >
							                                    	<input type="checkbox" class="jqForm" id="state8" name="state8" value="ABORTING"  <c:if test="${param.state8 == 'ABORTING' }" >checked="checked"</c:if>><label for="state8">ABORTING</label>
							                                    </td>
							                                </tr>
							                                <tr>
							                                	 <td class="condition_t_data" >
							                                    	<input type="checkbox" class="jqForm" id="state9" name="state9" value="TRANSFERRING"  <c:if test="${param.state9 == 'TRANSFERRING' }" >checked="checked"</c:if>><label for="state9">TRANSFERRING</label>
							                                    </td>
							                                	 <td class="condition_t_data" >
							                                    	<input type="checkbox" class="jqForm" id="state10" name="state10" value="ABORTED"  <c:if test="${param.state10 == 'ABORTED' }" >checked="checked"</c:if>><label for="state10">ABORTED</label>
							                                    </td>
							                                </tr>
							                                <tr>
							                                	 <td class="condition_t_data" >
							                                    	<input type="checkbox" class="jqForm" id="state11" name="state11" value="ALTERNATING"  <c:if test="${param.state11 == 'ALTERNATING' }" >checked="checked"</c:if>><label for="state11">ALTERNATING</label>
							                                    </td>
							                                	 <td class="condition_t_data" >
							                                    	<input type="checkbox" class="jqForm" id="state12" name="state12" value="CANCELING"  <c:if test="${param.state12 == 'CANCELING' }" >checked="checked"</c:if>><label for="state12">CANCELING</label>
							                                    </td>
							                                </tr>
							                                <tr>
							                                	 <td class="condition_t_data" >
							                                    	<input type="checkbox" class="jqForm" id="state13" name="state13" value="ALTERNATED"  <c:if test="${param.state13 == 'ALTERNATED' }" >checked="checked"</c:if>><label for="state13">ALTERNATED</label>
							                                    </td>
							                                	 <td class="condition_t_data" >
							                                    	<input type="checkbox" class="jqForm" id="state14" name="state14" value="CANCELED"  <c:if test="${param.state14 == 'CANCELED' }" >checked="checked"</c:if>><label for="state14">CANCELED</label>
							                                    </td>
							                                </tr>
							                            </tbody>
							                        </table>
                                ...
                                <div class="lay_item_right">
                                    ...
                                    <div class="opt_tit">
                                        <div class="opt_tit_left">
                                            <div class="elmt">
                                                <i id="foldTableBtn2" class="minus square icon large fixed" style="color:#ccd2de"></i>
                                                <span class="txt">LIST
                                                </span>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    $content = $("#body_${param.uuid }");
 	$(document).ready(function(){
			...
			if($content.find("#type").val() != "S"){
				$content.find('#time1<c:out value="${param.uuid }" />').trigger( "click" );
				$content.find("#singleFilterFrom").trigger("click");
				$content.find("#singleFilterTo").trigger("click");
				//$content.find("#fromMachineType1").trigger("click");
				//$content.find("#toMachineType1").trigger("click");
				$content.find("#searchOption1").trigger("click");
				$content.find("#state1").trigger("click");
			}
  ...
  // 테이블 컬럼 더블클릭 이벤트
	...
	function getLogList<c:out value="${param.uuid }" />(page){
		...
		}else if(searchOption == "lotId"){
			$content.find("#lotId").val($content.find("#carrierLotId").val());
		}
		
		var url = "<c:url value="/tran/ajax/getReturnJobLogList.do" />";
