...
<div class="contents_wrap" id="body_<c:out value="${param.uuid }" />">
     ...
     <div class="loc_info_basic">
         ...
         <span class="loc_info_ico loc_info_ico_arr_depth"></span>
         <span class="location_box">
             <a href="javascript:movePage('<c:url value="/tran/returnCmdLogList.do" />')" class="location"><spring:message code="site.returnCmdLogList" text="default text" /></a>
         </span>
     </div>
     <!-- //Location Information -->
     <!-- Page Title -->
     <table class="page_tit">
         <tr>
             <td class="tit_area">
                 <div class="tit"><spring:message code="site.returnCmdLogList" text="default text" /></div>
             </td>
         </tr>
     </table>
     <!-- //Page Title -->
				                            ...
				                            <tbody>
				                                ...
				                                <tr>
				                                    <td class="condition_t_data" colspan="2">
				                                        <input type="text" id="carrier" name="carrier" style="width: 250px" value="" />
				                                    </td>
				                                </tr>
				                            </tbody>
				                        </table>
     									...
     									<div class="condition_area">
				                            ...
				                            <tbody>
				                                <tr>
				                                    <td class="condition_t_head_top" colspan="2">
				                                    	<i class="minus square icon"></i>
				                                    	<span>TransportCommand ID</span>
				                                    </td>
				                                </tr>
				                                <tr>
				                                    <td class="condition_t_data" colspan="2">
				                                        <input type="text" id="transportCommandId" name="transportCommandId" style="width: 250px" value="" />
				                                    </td>
				                                </tr>
				                            </tbody>
				                        </table>
                                                ...
                                                <table class="condition_table" summary="<spring:message code="site.common.filter" text="default text" />">
						                            ...
						                            <tbody id="fromTest">
						                                <tr>
						                                    <td class="condition_t_head_top" colspan="3">
						                                    	<i class="minus square icon"></i>
						                                    	<span>From Machine</span>
						                                    </td>
						                                </tr>
						                                <tr>
						                                    <td class="condition_t_data" colspan="3">
						                                    	<input type="checkbox" class="jqForm" id="singleFilterFrom" name="singleFilterFrom" value="01" checked="checked" ><label for="singleFilter">Single Filter</label>
						                                    </td>
						                                </tr>		
						                                ...
						                                <tr  id="singleFilterChkBoxFromMachineType" >
						                                    <th scope="col" class="condition_t_head">Type</th>
						                                </tr>
						                                <tr class="singleFilterFrom">
						                                	<th scope="col" class="condition_t_head">NAME</th>
						                                ...
						                                <tr>
						                                    <td class="condition_t_data" colspan="3">
						                                    	<input type="checkbox" class="jqForm" id="multiFilterFrom" name="multiFilterFrom" value="02" <c:if test="${param.multiFilterFrom == '02' }" >checked="checked"</c:if>><label for="multiFilterFrom">Multi Filter</label>
						                                    </td>
						                                </tr>
						                                <tr class="singleFilterFrom">
						                                 	<td class="condition_t_data" colspan="3">
						                                    	 <input type="text" id="fromMachineName2" name="fromMachineName2"  style="width:163px" value="<c:out value="${param.fromMachineName2 }" />" />
				                                                 <div id="fromMachineBtn" class="mini ui primary button" style="width:93px;float: right;margin-left: 4px">
															 	 	<i class="tasks icon"></i>Machine
															 	 </div>
						                                    </td>
        									...
        									<div class="condition_area">
                                                <table class="condition_table" summary="<spring:message code="site.common.filter" text="default text" />">
						                            ...
						                            <tbody id="toTest">
						                                ...
						                                <tr>
						                                    <td class="condition_t_data" colspan="3">
						                                    	<input type="checkbox" class="jqForm" id="multiFilterTo" name="multiFilterTo" value="02" <c:if test="${param.multiFilterTo == '02' }" >checked="checked"</c:if>><label for="multiFilterTo">Multi Filter</label>
						                                    </td>
						                                </tr>
        								...
        								<div class="srch_type01">
                							<div class="condition_area">
							                    ...
							                    <tbody>
							                        ...
							                        <tr>
							                        	<th scope="col" class="condition_t_head" style="width:75px">From Unit</th>
							                            <td class="condition_t_data">
							                                <input type="text" id="fromUnit" name="fromUnit" style="width:190px" value="" />
							                            </td>
							                        </tr>
							                        <tr>
							                        	<th scope="col" class="condition_t_head">To Unit</th>
							                            <td class="condition_t_data">
							                                <input type="text" id="toUnit" name="toUnit" style="width:190px" value="" />
							                            </td>
							                        </tr>
							                    </tbody>
							                </table>
        								...
        								<div class="srch_type01">
                							<div class="condition_area">
							                    ...
							                    <tbody>
							                        ...
							                        <tr>
							                        	 <td class="condition_t_data" >
							                            	<input type="checkbox" class="jqForm" id="state1" name="state1" value="ALL"  checked="checked" ><label for="state1">ALL</label>
							                            </td>
							                        	 <td class="condition_t_data" >
							                            	<input type="checkbox" class="jqForm" id="state2" name="state2" value="CREATED" ><label for="state2">CREATED</label>
							                            </td>
							                        </tr>
							                        <tr>
							                        	 <td class="condition_t_data" >
							                            	<input type="checkbox" class="jqForm" id="state3" name="state3" value="QUEUING" ><label for="state3">QUEUING</label>
							                            </td>
							                        	 <td class="condition_t_data" >
							                            	<input type="checkbox" class="jqForm" id="state4" name="state4" value="WAITING"  ><label for="state4">WAITING</label>
							                            </td>
							                        </tr>
							                        <tr>
							                        	 <td class="condition_t_data" >
							                            	<input type="checkbox" class="jqForm" id="state5" name="state5" value="TRANSFERRING" ><label for="state5">TRANSFERRING</label>
							                            </td>
							                        	 <td class="condition_t_data" >
							                            	<input type="checkbox" class="jqForm" id="state6" name="state6" value="ALTERNATING"  ><label for="state6">ALTERNATING</label>
							                            </td>
							                        </tr>
							                        <tr>
							                        	 <td class="condition_t_data" >
							                            	<input type="checkbox" class="jqForm" id="state7" name="state7" value="CANCELING" ><label for="state7">CANCELING</label>
							                            </td>
							                        	 <td class="condition_t_data" >
							                            	<input type="checkbox" class="jqForm" id="state8" name="state8" value="CANCELED"  ><label for="state8">CANCELED</label>
							                            </td>
							                        </tr>
							                        <tr>
							                        	 <td class="condition_t_data" >
							                            	<input type="checkbox" class="jqForm" id="state9" name="state9" value="ABORTING" ><label for="state9">ABORTING</label>
							                            </td>
							                        	 <td class="condition_t_data" >
							                            	<input type="checkbox" class="jqForm" id="state10" name="state10" value="ABORTED" ><label for="state10">ABORTED</label>
							                            </td>
							                        </tr>
							                        <tr>
							                        	 <td class="condition_t_data" >
							                            	<input type="checkbox" class="jqForm" id="state11" name="state11" value="PAUSING" ><label for="state11">PAUSING</label>
							                            </td>
							                        	 <td class="condition_t_data" >
							                            	<input type="checkbox" class="jqForm" id="state12" name="state12" value="PAUSED" ><label for="state12">PAUSED</label>
							                            </td>
							                        </tr>
							                        <tr>
							                        	 <td class="condition_t_data" >
							                            	<input type="checkbox" class="jqForm" id="state13" name="state13" value="COMPLETED" ><label for="state13">COMPLETED</label>
							                            </td>
							                        	 <td class="condition_t_data" >
							                            	<input type="checkbox" class="jqForm" id="state14" name="state14" value="COMPLETEFAILED" ><label for="state14">COMPLETEFAILED</label>
							                            </td>
							                        </tr>
							                        <tr>
							                        	 <td class="condition_t_data" >
							                            	<input type="checkbox" class="jqForm" id="state15" name="state15" value="TERMINATED" ><label for="state13">TERMINATED</label>
							                            </td>
							                        	 <td class="condition_t_data" >
							                            </td>
							                        </tr>
...
<script type="text/javascript">
  	...
  	function setSearchOption<c:out value="${param.uuid }" />(colName , colValue){
  		...
  		switch(colName) {
  		    ...
  		    case "TRANSPORTCOMMANDID":
  		    	$content.find("input[name=transportCommandId]").val(colValue);
  		        break;
  		    case "SOURCEMACHINENAME":
  		    	$content.find("#transportMachineName1").val(colValue).prop("selected", true);
  		        break;
  		    case "DESTMACHINENAME":
  		    	$content.find("#toMachineName1").val(colValue).prop("selected", true);
  		        break;
  		   case "STATE":
 		    	$content.find(":checkbox[name^=state][value="+colValue+"]").trigger("click");
 		        break; 		        
  		    default:
  		}
  	}
	...
	function drawGrid<c:out value="${param.uuid }" />(){
		var columns = [
		  ...
		  {id: "TRANSPORTCOMMANDID", name: "TRANSPORTCOMMANDID", field: "TRANSPORTCOMMANDID", minWidth: 200, sortable: true},
		  {id: "TRANSPORTJOBID", name: "TRANSPORTJOBID", field: "TRANSPORTJOBID", minWidth: 200, sortable: true},
		  {id: "STATE", name: "STATE", field: "STATE", minWidth: 90, sortable: true},
		  ...
		  {id: "TRANSPORT MACHINE", name: "TRANSPORT MACHINE", field: "TRANSPORTMACHINENAME", minWidth: 100, sortable: true},
		  {id: "TRANSPORT MACHINETYPE", name: "TRANSPORT MACHINETYPE", field: "TRANSPORTTYPE2", minWidth: 100, sortable: true},
		  {id: "TRANSPORT UNIT", name: "TRANSPORT UNIT", field: "TRANSPORTUNITNAME", minWidth: 100, sortable: true},
		  {id: "TO TYPE", name: "TO TYPE", field: "DESTTYPE", minWidth: 60, sortable: true},
		  ...
		  {id: "DESCRIPTION", name: "DESCRIPTION", field: "DESCRIPTION", minWidth: 40, sortable: true}
		];
	var options = {
	...
	function getLogList<c:out value="${param.uuid }" />(page){
		...
		var url = "<c:url value="/tran/ajax/getReturnCmdLogList.do" />";
		...
		var states = $content.find(":checkbox[name^=state]:checked").map(function(){return $(this).val(); }).get().join();
