...
<div class="contents_wrap" id="body_<c:out value="${param.uuid }" />">
         ...
         <div class="loc_info_basic">
             ...
             <span class="loc_info_ico loc_info_ico_arr_depth"></span>
             <span class="location_box">
                 <a href="javascript:movePage('<c:url value="/tran/returnJobFailLogList.do" />')" class="location"><spring:message code="site.returnJobFailLogList" text="default text" /></a>
             </span>
         </div>
         <!-- //Location Information -->
         <!-- Page Title -->
         <table class="page_tit">
             <tr>
                 <td class="tit_area">
                     <div class="tit"><spring:message code="site.returnJobFailLogList" text="default text" /></div>
                 </td>
             </tr>
         </table>
         <!-- //Page Title -->
					                            ...
					                            <tbody>
					                                ...
					                                <tr>
					                                    <td class="condition_t_data" colspan="2">
					                                         ...
					                                         <input type="radio" class="jqForm" id="searchOption2" name="searchOption" value="lotId" <c:if test="${param.searchOption == 'lotId' }">checked="checked"</c:if> ><label for="searchOption2">Lot ID</label>
					                                    </td>
					                                </tr>
					                                <tr>
					                                    <td class="condition_t_data" colspan="2">
					                                        <input type="text" id="carrierLotId" name="carrierLotId" value="" style="width:210px" />
					                                    </td>
					                                </tr>
					                            </tbody>
					                        </table>
					                            ...
					                            <tbody id="transportCommand">
					                                ...
					                                <tr>
					                                    <td class="condition_t_data" colspan="3">
					                                    	<input type="text" id="transportJobId" name="transportJobId" value="" style="width:210px" />
					                                    </td>
					                                 </tr>
					                               </tbody>
					                               </table>
         									...
         									<div class="condition_area">
                                                 <table class="condition_table" summary="<spring:message code="site.common.filter" text="default text" />">
						                            ...
						                            <tbody id="test">
						                                ...
						                                <tr>
						                                    <td class="condition_t_data" colspan="3">
						                                    	<input type="checkbox" class="jqForm" id="singleFilterFrom" name="singleFilterFrom" value="01" <c:if test="${param.singleFilterFrom == '01' }" >checked="checked"</c:if> ><label for="singleFilterFrom">Single Filter</label>
						                                    </td>
						                                </tr>
						                                ...
						                                <tr>
						                                    <td class="condition_t_data" colspan="3">
						                                    	<input type="checkbox" class="jqForm" id="multiFilterFrom" name="multiFilterFrom" value="02" <c:if test="${param.multiFilterFrom == '02' }" >checked="checked"</c:if>><label for="multiFilter">Multi Filter</label>
						                                    </td>
						                                </tr>
        									...
        									<div class="condition_area">
                                                <table class="condition_table" summary="<spring:message code="site.common.filter" text="default text" />">
						                            ...
						                            <tbody id="test">
						                                ...
						                                <tr>
						                                    <td class="condition_t_data" colspan="3">
						                                    	<input type="checkbox" class="jqForm" id="singleFilterTo" name="singleFilterTo" value="01" <c:if test="${param.singleFilterTo == '01' }" >checked="checked"</c:if> ><label for="singleFilterTo">Single Filter</label>
						                                    </td>
						                                </tr>
						                                ...
						                                <tr >
						                                    <td class="condition_t_data" colspan="3">
						                                    	<input type="checkbox" class="jqForm" id="multiFilterTo" name="multiFilterTo" value="02" <c:if test="${param.multiFilterTo == '02' }" >checked="checked"</c:if>><label for="multiFilter">Multi Filter</label>
						                                    </td>
						                                </tr>
...
<script type="text/javascript">
	...
	function drawGrid<c:out value="${param.uuid }" />(){
		var columns = [
		  ...
		  {id: "TRASPORTJOBID", name: "TRASPORTJOBID", field: "TRANSPORTJOBID", minWidth: 200, sortable: true},
	...
	function getLogList<c:out value="${param.uuid }" />(page){
		...
		var url = "<c:url value="/tran/ajax/getReturnJobFailLogList.do" />";
	...
	$content.find(".board_list_data").dblclick(function() {
		...
		switch(colName) {
		    case "carrier":
		        ...
		        break;
		    case "transportJobId":
		    	$content.find("#transportJobId").val(colValue).prop("selected", true);
		        break;
