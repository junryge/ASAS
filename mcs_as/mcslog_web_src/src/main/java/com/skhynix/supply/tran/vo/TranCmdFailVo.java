 ...
 * @FileName : TotalVo.java
 * @작성일 : 2017. 3. 9.
 * @작성자 : angelot
 * @프로그램 설명 : 기본 로그조회 화면에 대한 VO
 */
public class TranCmdFailVo {
...
//	}
	...
	public String getTransportCmdId() {
		return transportCmdId;
	}
	public void setTransportCmdId(String transportCmdId) {
		this.transportCmdId = transportCmdId;
	}
