 ...
 */
@Controller
public class ResPortHistoryController {
	protected Log log = LogFactory.getLog(ResPortHistoryController.class);
	@Resource(name = "resPortHistoryServiceImpl")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "res/portLogList")
	public ModelAndView portLogList(@ModelAttribute ResPortVo param, HttpServletRequest request)
			throws Exception {
...
//		param.setFabSite(sFabSite);
		...
		mav.setViewName("res/portLogList");
		return mav;
	}
	
	@SuppressWarnings("rawtypes")
	@RequestMapping(value = "res/ajax/getPortLogList")
	public ModelAndView getPortLogList(@ModelAttribute ResPortVo param, HttpServletRequest request) throws Exception {
		ModelAndView mav = new ModelAndView();
