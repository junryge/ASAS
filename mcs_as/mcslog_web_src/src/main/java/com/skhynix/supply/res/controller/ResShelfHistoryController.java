 ...
 */
@Controller
public class ResShelfHistoryController {
	protected Log log = LogFactory.getLog(ResShelfHistoryController.class);
	@Resource(name = "resShelfHistoryServiceImpl")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "res/shelfLogList")
	public ModelAndView portLogList(@ModelAttribute ResShelfVo param, HttpServletRequest request) 	throws Exception {
...
//		param.setFabSite(sFabSite);
		...
		mav.setViewName("res/shelfLogList");
		return mav;
	}
	@SuppressWarnings("rawtypes")
	@RequestMapping(value = "res/ajax/getShelfLogList")
	public ModelAndView getShelfLogList(@ModelAttribute ResShelfVo param, HttpServletRequest request) 	throws Exception {
		ModelAndView mav = new ModelAndView();
