 ...
 * @FileName   : ResPortHistoryController.java
 * @작성일        : 2017. 3. 21. 
 * @작성자        :  박민호
 * @프로그램 설명 : 포트 이력 조회 컨트롤러
 */
@Controller
public class ResVehicleHistoryController {
	protected Log log = LogFactory.getLog(ResVehicleHistoryController.class);
	@Resource(name = "resVehicleHistoryServiceImpl")
	...
	/**
	 * @Method Name  : portLogList
	 * @작성일     : 2017. 3. 21. 
	 * @작성자     : 박민호
	 * @param    :
	 * @Method 설명 : Port 이력 조회
	 * @param param
	 * @param request
	 * @return
	 * @throws Exception
	 */
	@RequestMapping(value = "res/vehicleLogList")
	public ModelAndView portLogList(@ModelAttribute ResVehicleVo param, HttpServletRequest request)	throws Exception {
...
//		param.setFabSite(sFabSite);
		...
		mav.setViewName("res/vehicleLogList");
		return mav;
	}
	
	@SuppressWarnings("rawtypes")
	@RequestMapping(value = "res/ajax/getVehicleLogList")
	public ModelAndView getVehicleLogList(@ModelAttribute ResVehicleVo param, HttpServletRequest request)	throws Exception {
		ModelAndView mav = new ModelAndView();
