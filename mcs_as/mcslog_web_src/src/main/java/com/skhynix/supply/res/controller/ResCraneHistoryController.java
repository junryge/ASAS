 ...
 */
@Controller
public class ResCraneHistoryController {
	protected Log log = LogFactory.getLog(ResCraneHistoryController.class);
	@Resource(name = "resCraneHistoryServiceImpl")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "res/craneLogList")
	public ModelAndView carrierLocLogList(@ModelAttribute ResCraneVo param, HttpServletRequest request)	throws Exception {
...
//		param.setFabSite(sFabSite);
		...
		mav.setViewName("res/craneLogList");
		return mav;
	}
	
	@SuppressWarnings("rawtypes")
	@RequestMapping(value = "res/ajax/getCraneLogList")
	public ModelAndView getCraneLogList(@ModelAttribute ResCraneVo param, HttpServletRequest request) throws Exception {
		ModelAndView mav = new ModelAndView();
