 ...
 * 
 */
package com.skhynix.supply.alarm.controller;
...
/**
 * @Package Name   : com.skhynix.supply.alarm.controller
 * @FileName   : AlarmReportController.java
 * @작성일        : 2017. 3. 21. 
 * @작성자        :  박민호
 * @프로그램 설명 : alarmReport 조회 컨트롤러
 */
@Controller
public class AlarmReportController {
	protected Log log = LogFactory.getLog(AlarmReportController.class);
	@Resource(name = "alarmReportService")
	 ...
	 * @작성자     : 박민호
	 * @param    :
	 * @Method 설명 : alarmReport 로그 조회 화면
	 * @param param
	 * @param request
	 * @return
	 * @throws Exception
	...
	public ModelAndView alarmReportLogList(@ModelAttribute AlarmReportVo param, HttpServletRequest request)	throws Exception {
		...
		//fab
		mav.addObject("fabs", Common.getFabList("alarm", sFabSite));
		param.setFab(Common.getBasicFabList("alarm", sFabSite));
		//level
		...
		mav.setViewName("alarm/alarmReportLogList");
		return mav;
	}
	
	/**
	 * @Method Name  : getAlarmReportLogList
	 * @작성일     : 2017. 3. 27. 
	 * @작성자     : 박민호
	 * @param    :
	 * @Method 설명 : alarmReport 로그 조회(ajax)
	 * @param param
	 * @param request
	 * @return
	 * @throws Exception
	...
	public ModelAndView getAlarmReportLogList(@ModelAttribute AlarmReportVo param, HttpServletRequest request)	throws Exception {
		ModelAndView mav = new ModelAndView();
...
//		}
		...
		//List<String> fabList = Common.getFabList("alarm", Common.sFAB_SITE);		
		List<String> fabList = Common.getFabList("alarm", sFabSite);
...
//		}
		...
		List list = alarmReportService.getDataList(param);
