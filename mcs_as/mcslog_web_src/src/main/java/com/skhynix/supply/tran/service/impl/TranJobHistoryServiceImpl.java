 ...
 */
@Service("tranJobHistoryService")
public class TranJobHistoryServiceImpl implements TranService {
	protected Log log = LogFactory.getLog(TranJobHistoryServiceImpl.class);
	...
	public List<Map> getDataList(TranVo tranVo) throws Exception {
		...
		String resultQuery = getTranJobHistoryQueryParser(tranVo);
	...
	/**
	 * @Method Name : getTranJobHistoryQueryParser
	 * @작성일 : 2017. 3. 20.
	 * @작성자 : 최명수
	 * @param :
	 * @Method 설명 : 반송 이력 조회
	 ...
	 * @throws Exception
	 */
	public String getTranJobHistoryQueryParser(TranVo tranVo){
		if (tranVo == null) {
			return null;
		} // null exception
...
//				+ Common.sComma + Common.sSTATE + Common.sComma + Common.sFIXEDROUTE
...
//				+ Common.sSOURCEUNITNAME + Common.sComma + Common.sCREATEUSER + Common.sComma + Common.sBATCHTYPE
//				);
